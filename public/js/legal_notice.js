...
const content_contact = document.getElementById('content_contact');


// TABLEAUX CONTENANT LES CONTENUS ET LES TITRES
const titles = [intro, collecte, personnal_caracteres, cookies, security, concerned_person, edits, contact];
const contents = [content_intro, content_collecte, content_personnal_caracteres, content_cookies, content_security, content_concerned_person, content_edits, content_contact];
